...
<script type="text/javascript">
    ...
    function getBtnEnable() {
        var _localChannel = "<%=this.channel_id%>";
        if (_localChannel != "2")
        {
            $("#show_record").hide();
        }
    ...
    //打开进货记录
    function show_goods_list(obj) {
        var objNum = arguments.length;
        var d = top.dialog({
            id: 'goods_records_list',
            width: "1200",        //宽度
            height: "600",        //高度
            title: '进/出货记录',
            url: 'article/goods_records_list.aspx?good_id=' + obj
        }).showModal();
    }
</script>
</head>
    ...
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          ...
          <li><asp:LinkButton ID="show_record" runat="server" onclick="btnshow_record"><i class="iconfont icon-log"></i><span>进/出货记录</span></asp:LinkButton></li>
        </ul>
        <div class="menu-list">
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
      <th width="6%">选择</th>
      <th align="left">标题</th>
      <th align="center" width="16%">发布时间</th>
      <th align="center" width="65">排序</th>
      <th align="center" width="120">属性</th>
      <th width="10%">操作</th>
    </tr>
  </HeaderTemplate>
  <ItemTemplate>
