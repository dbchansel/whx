...
namespace DTcms.Web.admin
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Utils.WriteCookie("AdminUserId", "DTcms", model.user_name);
            Utils.WriteCookie("AdminRoleId", "DTcms", model.role_id);
            Utils.WriteCookie("AdminPwd", "DTcms", model.password);
            Utils.WriteCookie("AdminCreateUserId", "DTcms", model.CreateUserId);
