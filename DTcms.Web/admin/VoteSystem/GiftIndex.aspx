<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GiftIndex.aspx.cs" Inherits="DTcms.Web.admin.VoteSystem.GiftIndex"  ValidateRequest="false" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="8%">支付状态</th> 
    <th align="left" width="8%">支付创建时间</th>
    <th align="left" width="8%">支付完成时间</th>
    <th width="5%">钱数</th>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#getHDTitle(Eval("voteid").ToString())%></td>
    <td><center><%#getDPName(Eval("voteid").ToString())%></center></td>
    <td><%#Eval("order_no")%></td>
    <td><%#Eval("payment_status").ToString()== "2" ? "完成订单" : "订单未支付" %> </td>
    <td><%#Eval("add_time").ToString() %></td>
    <td><%#Eval("complete_time").ToString() %></td>
