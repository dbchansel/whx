...
namespace DTcms.Web.UI
{
    public class ManagePage : System.Web.UI.Page
    {
        ...
        protected void JsonResult(object data)
        {
            ...
            //Response.Write(AESEncrypt(JsonConvert.SerializeObject(data, Formatting.Indented, timeConverter)));
            //Response.End();

        }

        protected void ExcuteJS(string fun_name,object sendData)
        {
            ClientScript.RegisterClientScriptBlock(this.GetType(), fun_name, fun_name + "('" + sendData + "')", true);
        }
