...
namespace DTcms.DAL
{
    ...
    public partial class erp_record_Info
    {
        ...
        public erp_record_Info(string _databaseprefix)
        {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from  " + databaseprefix + "erp_record_Info");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.erp_record_Info model)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            strSql.Append("insert into  " + databaseprefix + "erp_record_Info(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.erp_record_Info model)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            PropertyInfo[] pros = model.GetType().GetProperties();
            List<SqlParameter> paras = new List<SqlParameter>();
            strSql.Append("update  " + databaseprefix + "erp_record_Info set ");
            foreach (PropertyInfo pi in pros)
            {
                //如果不是主键则追加sql字符串
                if (!pi.Name.Equals("id"))
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from " + databaseprefix + "erp_record_Info ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.erp_record_Info GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Model.erp_record_Info model = new Model.erp_record_Info();
            //利用反射获得属性的所有公共属性
            PropertyInfo[] pros = model.GetType().GetProperties();
            ...
            strSql.Append(" from " + databaseprefix + "erp_record_Info");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM " + databaseprefix + "erp_record_Info");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.erp_record_Info GetModel(string nav_name)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Model.erp_record_Info model = new Model.erp_record_Info();
        ...
        /// 得到一个对象实体，带事务
        /// </summary>
        public Model.erp_record_Info GetModel(SqlConnection conn, SqlTransaction trans, string nav_name)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Model.erp_record_Info model = new Model.erp_record_Info();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id from " + databaseprefix + "erp_record_Info");
            strSql.Append(" where name=@nav_name");
            SqlParameter[] parameters = {
                    new SqlParameter("@nav_name", SqlDbType.NVarChar,50)};
            parameters[0].Value = nav_name;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,parent_id from " + databaseprefix + "erp_record_Info");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "erp_record_Info set " + strValue);
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "erp_record_Info set name=@new_name");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM " + databaseprefix + "erp_record_Info where parent_id='"+ id + "'");
        ...
        /// 将对象转换实体
        /// </summary>
        public Model.erp_record_Info DataRowToModel(DataRow row)
        {
            Model.erp_record_Info model = new Model.erp_record_Info();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_erp_record_Info");
            strSql.Append(" order by sort_id asc,id asc");
            DataSet ds = DbHelperSQL.Query(strSql.ToString());
            //重组列表
            DataTable oldData = ds.Tables[0] as DataTable;
        ...
        public int GetCurDayCurVoteCount(string openid, int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_erp_record_Info");
            strSql.Append(" where erp_record_InfoId='" + openid + "' and PointId=" + id + " and year(CreateDate)=" + DateTime.Now.Year + " and MONTH(CreateDate)=" + DateTime.Now.Month + " and DAY(CreateDate)=" + DateTime.Now.Day);
            DataSet ds = DbHelperSQL.Query(strSql.ToString());
            //重组列表
            DataTable oldData = ds.Tables[0] as DataTable;
        ...
        public int GetCurDayCount(string openid)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_erp_record_Info");
            strSql.Append(" where erp_record_InfoId='" + openid + "' and year(CreateDate)=" + DateTime.Now.Year + " and MONTH(CreateDate)=" + DateTime.Now.Month + " and DAY(CreateDate)=" + DateTime.Now.Day);
            DataSet ds = DbHelperSQL.Query(strSql.ToString());
            //重组列表
            DataTable oldData = ds.Tables[0] as DataTable;
            return oldData.Rows.Count;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 CreateDate from " + databaseprefix + "erp_record_Info where erp_record_InfoId='" + openid + "'");
