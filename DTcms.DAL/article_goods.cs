...
namespace DTcms.DAL
{
    ...
    public partial class article_goods
    {
        ...
        public bool upsertNum(string num,string id)
        {
            return DbHelperSQL.ExecuteSql(" update dt_channel_article_goods set stock_quantity='"+ num + "' where id='"+ id + "'") > 0;
        }
        ...
        public Model.article_goods GetModel_item(int id)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Model.article_goods model = new Model.article_goods();
            ...
            strSql.Append("select top 1 " + str1.ToString().Trim(','));
            strSql.Append(" from dt_channel_article_goods ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
