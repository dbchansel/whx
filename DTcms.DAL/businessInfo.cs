...
namespace DTcms.DAL
{
    ...
    public partial class businessInfo
    {
        ...
        public businessInfo(string _databaseprefix)
        {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from  " + databaseprefix + "businessInfo");
            strSql.Append(" where ");
            strSql.Append(" id = @id  ");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.businessInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            strSql.Append("insert into  " + databaseprefix + "businessInfo(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.businessInfo model)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            PropertyInfo[] pros = model.GetType().GetProperties();
            List<SqlParameter> paras = new List<SqlParameter>();
            strSql.Append("update  " + databaseprefix + "businessInfo set ");
            foreach (PropertyInfo pi in pros)
            {
                //如果不是主键则追加sql字符串
                if (!pi.Name.Equals("id"))
        ...
        public bool Delete(int id)
        {
            ...
            strSql1.Append("delete from " + databaseprefix + "businessInfo_relation");
            ...
            //删除主表
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from " + databaseprefix + "businessInfo");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.businessInfo GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Model.businessInfo model = new Model.businessInfo();
            //利用反射获得属性的所有公共属性
            PropertyInfo[] pros = model.GetType().GetProperties();
            ...
            strSql.Append(" from " + databaseprefix + "businessInfo");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
                    new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select *,(select count(1) from " + databaseprefix + "businessInfo_relation where tag_id=" + databaseprefix + "businessInfo.id) as count");
            strSql.Append(" FROM " + databaseprefix + "businessInfo");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" *,(select count(1) from " + databaseprefix + "businessInfo_relation where tag_id=" + databaseprefix + "businessInfo.id) as count");
            strSql.Append(" FROM  " + databaseprefix + "businessInfo");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select *,(select count(0) from " + databaseprefix + "businessInfo_relation where tag_id=" + databaseprefix + "businessInfo.id) as count FROM " + databaseprefix + "businessInfo");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "businessInfo set " + strValue);
            strSql.Append(" where id=" + id);
        ...
        public void Update(SqlConnection conn, SqlTransaction trans, string tags_title, int channel_id, int article_id)
        {
            ...
            //检查该Tags标签是否已存在
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id from " + databaseprefix + "businessInfo");
            strSql.Append(" where title=@title");
            SqlParameter[] parameters = {
            ...
            if (tagsId == 0)
            {
                ...
                strSql2.Append("insert into " + databaseprefix + "businessInfo(");
            ...
            if (tagsId > 0)
            {
                ...
                strSql3.Append("insert into " + databaseprefix + "businessInfo_relation(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from " + databaseprefix + "businessInfo_relation");
        ...
        /// 将对象转换实体
        /// </summary>
        public Model.businessInfo DataRowToModel(DataRow row)
        {
            Model.businessInfo model = new Model.businessInfo();
            if (row != null)
            {
